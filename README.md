...
1. **安装 Python**（如果没有的话）：
   - [Windows 下载 Python 3.14+](https://www.python.org/downloads/windows/)
   - Linux/macOS: `brew install python` 或系统包管理器安装
   - ⚠️ 安装时务必勾选 **Add Python to PATH**
2. [注册 DeepSeek](https://platform.deepseek.com) 获取 API Key
3. 下载 [最新版 ZIP](https://lnpiao.cn/eva/)
4. 解压，双击启动：
   - Windows：`start_windows.bat`
   - Linux/macOS：`start_linux.sh`
5. 按引导配置 API Key，开始使用
4. 粘贴 Key，开始使用
